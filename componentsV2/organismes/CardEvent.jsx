...
const CardEvent = ({ eventImage, name, eventDate, place, price, liked, toggleLiked = () => { }, action = () => { }, ...props }) => {
  return (
    <Container.ButtonContainer flexDirection={'column'} gap={'10px'} justifyContent={'flex-start'} paddingHorizontal={props.rectangle ? '10px' : '0px'} paddingVertical={props.rectangle ? '10px' : '0px'} bgColor={props.rectangle && useThemeColor("secondaryDark")} borderRadius={props.rectangle && 12.00} onPress={action} {...props}>
